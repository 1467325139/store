...
print("---------------------------------------------")
print("12月份销售总金额  ￥",(198400.6))

print("羽绒服本月销售量占比",('{:.2%}'.format((10+69+140+10+10)/500)))
print("牛仔裤本月销售量占比",('{:.2%}'.format((60+72+35+90+60+60+140)/600)))
print("风衣本月销售量占比",('{:.2%}'.format((43+25+43+60+43+78)/335)))
print("皮草本月销售量占比",('{:.2%}'.format((63+24+63+57)/855)))
print("T恤本月销售量占比",('{:.2%}'.format((63+45+129+63+58+48+63)/632)))
print("衬衫本月销售量占比",('{:.2%}'.format(120/562)))
print("羽绒服本月销售额占比",('{:.2%}'.format((10+69+140+10+10)*253.6/198400.6)))
print("牛仔裤本月销售额占比",('{:.2%}'.format((60+72+35+90+60+60+140)*86.3/198400.6)))
print("风衣本月销售额占比",('{:.2%}'.format((43+25+43+60+43+78)*96.8/198400.6)))
print("皮草本月销售额占比",('{:.2%}'.format((63+24+63+57)*135.9/198400.6)))
print("T恤本月销售额占比",('{:.2%}'.format((63+45+129+63+58+48+63)*65.8/198400.6)))
print("衬衫本月销售额占比",('{:.2%}'.format(120*49.3/198400.6)))
